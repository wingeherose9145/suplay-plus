...
class FakeCalculatorActivity : AppCompatActivity() {
    ...
    private val randomTexts = listOf(
        ...
        "iħ ∂ψ/∂t = Hψ", "E = hf", "c = λf", "pV = NkT", "山椒は小粒でもぴりりと辛い（さんしょうはこつぶでもぴりりとからい）",
        "a² + b² = c²", "σ = εE", "V = IR", "Q = mcΔT", "栴檀は双葉より芳し（せんだんはふたばよりかんばし）",
        "S = k lnΩ", "λ = h/p", "欲正其心者，先诚其意；欲诚其意者，先致其知。", "余知百病生于气也。怒则气上，喜则气缓，悲则气消，恐则气下，惊则气乱，思则气结。", "泰山鳴動して鼠一匹（たいざんめいどうしてねずみいっぴき）"
    )
